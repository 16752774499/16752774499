                            ...
                            html += '</div>';
                             ...
                             layui.each(res.data, function(index, item){
                                ...
                                //库存为0的
                                    ...
                                    html += '';
                                    if(item.price <=0){
                                        buy = '<div style="height: 2rem"><span class="buy" style="font-size: 13px;background: #yellowgreen;color:#fff;display: inline-block;height: 2rem;line-height: 0.9rem;float: right;padding: 0rem 0.45rem;width:100%;border-radius: 0.2rem;    border: 1px solid transparent;text-align:center;">免费领<br>限时抢购</span></div>';
                                    }else{
                                        buy = '<div style="height: 2rem"><span class="buy" style="font-size: 13px;background: #fd2411;color:#fff;display: inline-block;height: 2rem;line-height: 0.9rem;float: right;padding: 0rem 0.45rem;width:100%;border-radius: 0.2rem;    border: 1px solid transparent;text-align:center;">马上抢<br>正在热卖</span></div>';
                                    }

                                    if(item.stock == 0){
                                        buy = '<div style="height: 2rem"><span class="buy" style="font-size: 13px;background: #aeadad;color:#fff;display: inline-block;height: 2rem;line-height: 0.9rem;float: right;padding: 0rem 0.45rem;width:100%;border-radius: 0.2rem;    border: 1px solid transparent;text-align:center;">已卖光<br>暂时缺货</span></div>';
                                    }
