...
$DB->exec("DELETE FROM `pre_points` WHERE addtime<'".date("Y-m-d H:i:s",strtotime("-30 days"))."'");
$DB->exec("OPTIMIZE TABLE `pre_points`");
showmsg('删除30天前收支明细成功！',1);
...
<a href="./clean.php?mod=cleanpoints" onclick="return confirm('你确实要删除30天前收支明细吗？');" class="btn btn-block btn-default">删除30天前收支明细</a><br/>
