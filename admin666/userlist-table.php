...
?>
	  <div class="table-responsive">
        <table class="table table-striped">
            【<a href="sitelist.php">查看分站代理</a>】
          <thead><tr><th>用户ID</th><th>上级ID</th><th>用户名</th><th>余额</th><th>注册时间</th><th>QQ</th><th>某种神秘代码</th><th>状态</th><th>操作</th></tr></thead>
          <tbody>
<?php
$pagesize=30;
