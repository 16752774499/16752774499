...
<li class="<?php echo checkIfActive('sitelist,tixian,article,rewrite,rank,userlist,message,workorder,siteprice,kmlist')?>">
...
<li class="<?php echo checkIfActive('shequlist,pricejk,log,clone,cloneset,shequ,orderjk,batchgoods,batchgoods1,kakayun')?>">
...
<li class="<?php echo checkIfActive('site,mail,pay,template,template2,gonggao,upimg,upbgimg,clean,cleanbom,defend,proxy,copygg,mailtest,epay,captcha,fenzhan,cron,oauth,dwz,appCreate,account,ips')?>">
...
<li class="<?php echo checkIfActive('seckill,choujiang,invite,qiandao,invitelog,zsrwzq,fxsz,faquan,shopaudit,zsqtpz01')?>">
	<a href="javascript:void(0)" class="sidebar-nav-menu"><i class="fa fa-chevron-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="fa fa-cog sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">知识付费模板管理</span></a>
	<ul>
<li>
