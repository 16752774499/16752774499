...
<div class="fui-page  fui-page-current" style="max-width: 550px;left: auto;">
    ...
    <div style="width:100%;" class="fui-content member-page navbar ">
		 ...
		 <?php if($userrow['power']==2){$img='fenzhan2'; $list='5';}else if($userrow['power']==1){;$img='fenzhan1';$list='3';}else{$img='fenzhan0';}?>
			 <div class="display-row align-center justify-between" style="width:100%;height:31%;padding:0 1rem">
                       ...
                       <font style="color:#fff;font-weight:600;font-size:.7rem">
                           <?php if($userrow['power']==2){echo '顶级合伙人'; $font='SENIOR PARTNER';}else if($userrow['power']==1){echo '分站站长';
                           $font='STATIONMASTER';}else{echo '注册用户';$font='REGULAR MEMBERS';}?>
        ...
        <?php }?>
          ...
          <?php  if($userrow['power']==1 || $userrow['power']==2){?>
                <div class="fui-cell-group fui-cell-click max-width" >
                        ...
                        <div class="image">
                            <a href="JavaScript:void(0)" onclick="$('.tzgg').show()"><img src="<?php echo $cdnserver?>template/storenews/image/user/img/1516.png"></a>
                        </div>
                        <div class="text" style="height: 1.2rem;line-height: 1.2rem">
                            <ul>
                                <li><a href="JavaScript:void(0)" onclick="$('.tzgg').show()">

                                        <marquee behavior="scroll"><span>️站长合伙人请第一时间务必生成下载APP，防止网站进不去！</span></marquee>
       ...
       <?php  if($userrow['power']==0){?>
                <div style="width:48%;height:100%;border-radius: 0 .6rem 0 .6rem ;background:#f5f7f9;" class="display-row align-center">
                                             <a href="javascript:layer.msg('只有开通分站站长或顶级合伙人才可进行提现');" style="color:#acb1b1;font-size:.7rem;width:50%; height:100%;" class="display-row align-center justify-center">提现</a>
           <?php }?>
       ...
       <?php  if($userrow['power']==1 || $userrow['power']==2){?>
                ...
                <div class="fui-icon-group selecter col-3">
                    ...
                    <a class="fui-icon-col external left-border right-border " href="material.php">
                        <div class="icon1 icon-orange radius">
       ...
       <?php  if($userrow['power']==1 || $userrow['power']==2){?>
        ...
        <div class="fui-cell-group fui-cell-click max-width">
                <div class="fui-according-group " style="display: block;margin-top:unset;">
                        ...
                        <div class="fui-cell-img">
                            <img width="100%" src="<?php echo $cdnserver?>template/storenews/image/user/img/guanggao1.png">
                        </div>
                    	...
                    	<?php if($conf['appcreate_open']==1){?>
            		  	...
            		  	<?php }?><?php }?>
                                  ...
                                  <?php  if( $userrow['power']==1){?>
            		                     <a class="fui-cell external" href="upsite.php">
                        <div class="fui-cell-img">
                            <img width="100%" src="<?php echo $cdnserver?>template/storenews/tupian/shengji.png">
                        </div>
                        <div class="fui-cell-text"><p>自助升级合伙人</p></div>
                        <div class="fui-cell-remark" >
                        </div>
                    </a>
                    <?php }?>
