...
$level = '<font color="#48d1cc">注册用户售价</font>';
if($islogin2==1){
	$price_obj = new \lib\Price($userrow['zid'],$userrow);
	if($userrow['power']==2){
		$level = '<font color="orange">顶级合伙人售价</font>';
	}elseif($userrow['power']==1){
		$level = '<font color="red">分站站长售价</font>';
	}
    ...
    <div class="layui-row layui-col-space8">
        <div class="layui-col-xs12"
            ...
            <a href="javascript:history.go(-1)">
                <p style="margin-top: 0.5em;font-size: 1.2em"><span class="layui-icon layui-icon-left"></span> 确认订单</p>
            </a>
        </div>
                ...
                <div class="layui-card-body layui-form layui-form-pane" style="padding: 0.5em">
                    ...
                    <div id="demo_url" data-url="<?php echo $share_link ?>" style="padding: 0.3em;border-radius: 0.3em;line-height: 2em;height: 2.5em">
                        <input type="radio" name="pay" value="help"
                             ...
                             <div class="layui-card-header" onclick="mz_cz()">
                    <i class="layui-icon layui-icon-release"></i>  
    <span style="color: #FF0000;"><strong>&nbsp;&nbsp;截图领取支付宝红包码[领券下单更优惠]</strong></span>
    </div>
        <img style="display: inline-block; width: 50%; max-width: 50%; height: auto;" src="./assets/user/img/hongbao1.jpg" />
        ...
        <div class="layui-col-xs12" style="z-index: 3;;background-color: white;position: fixed;bottom: 0;left: 0;height: 4em;line-height: 3.5em;box-shadow: 0px 0px 8px #ccc;text-align: right;">
...
layui.use('form', function(){
  ...
  form.render('radio');
  layer.alert('    1.下单前请你知悉并确认，本站项目为虚拟产品，购买本站产品，你已支付的费用将不予退还，不支持退款！但是<span style="color: #ff0000;">包售后，包更新，包维护。</span></p >2.如你有关于产品售后相关的问题需要咨询或建议，可以通过<span style="color: #ff0000;">【会员中心-售后反馈】</span>提交工单形式联系客服进行反馈，客服会在12小时内进行处理解答，敬请关注工单状态。</p >3.你下单的订单信息可在<span style="color: #ff0000;">【会员中心-订单管理】</span>内输入你下单时填写的<span style="color: #ff0000;" >【邮箱账号/手机号】</span>查询订单记录。</p >');
});
