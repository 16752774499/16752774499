...
<div id="body" style="width: 100%;max-width: 550px">
    ...
    <div class="top" style="background:#fff">
        <div class="toptitle" style="font-size: 15px;color:#000">
            我的订单
        </div>
            </div>
...
<div class="fui-content navbar order-list">
    <div class="fui-content-inner">
        <div class="content-empty" style="">
        	<img src="img/mescroll-empty.png" style="width: 50%;height:50%;margin-bottom: .5rem;"><br>
        		            <p style="color: #999;font-size: .65rem">~ 暂无相关订单 ~</p>
        		            <br>
        		            <a href="./" class="btn btn-sm" style="color: #ffffff;border-radius: 100px;height: 1.5rem;width: 5rem;font-size: 0.65rem;background:#678efe;color:#fff">去逛逛</a>
...
<!--                             <?php if ($conf['gg_search'] != '') { ?>
        ...
        <div class="fui-navbar" style="max-width: 550px;z-index: 100;">
            <a href="./" class="nav-item  "><img src="./img/home.png">  <span class="label" style="color:#999;line-height: unset;font-weight: inherit;">首页</span>
            </a>
           
            <a href="./?mod=query" class="nav-item active"> <img src="./img/order-index.png"> <span
                        class="label" style="color:#2f6eff;line-height: unset;font-weight: inherit;">订单</span> </a>
    <a href="./?mod=kf" class="nav-item "> <img src="./img/kf.png"><span class="label" style="color:#999;line-height: unset;font-weight: inherit;">客服</span>
    </a>
            <a href="./user/" class="nav-item "> <img src="./img/my.png"> <span
                        class="label" style="color:#999;line-height: unset;font-weight: inherit;">我的</span> </a>
        </div>
