...
<div id="body">
    ...
    z-index: 9;">
                        ...
                        <div class="account-red" style="text-align:center;width:85%">
                            <a style="color: #868282;">还没有登录账号？</a><a href="reg.php" style="color: #1c4587;"><b>立即注册</b></a>
                        </div>
                      
                        <div style="text-align: center;margin-bottom: 5px;color:#999;margin-top: 15px;"> 
                                                <div style="text-align: center;margin-bottom: 5px;color:#999;margin-top: 15px;"> 
                            <div style="color:#fff;position: relative;top: 0px;width: 345px;font-size:13px;margin: auto">            ---------------  其他登录方式  --------------- </div>
						 <div style="text-align: center;margin-bottom: 5px;color:#999;margin-top: 15px;"> 
...
<script src="../assets/js/login.js?ver=2055"></script>
