...
<style>html {
        background: #ecedf0 url("//cn.bing.com/th?id=OHR.CuxhavenTower_ZH-CN5580118944_1920x1080.jpg&rf=LaDigue_1920x1080.jpg&pid=hp") fixed;
    ...
    <div class="fui-page-group fui-page-group-bg  statusbar" style="max-width: 550px;left: auto;">
	    ...
	    opacity: .8;align-items: center;justify-content: space-between;display: flex; flex-direction: row;height: 30px;z-index:9999">
                <a href="javascript:history.back()" class="font-weight display-row align-center"
                   style="height: 1.6rem;line-height: 1.65rem;width: 50%">
    ...
    z-index: 9;">
                            ...
                            <div class="account-group">
                                <div class="account-input-group">
                                    ...
                                    <input type="text" name="user" value="" class="account-group-input"
                                           required="required" placeholder="输入登录用户名"/>
                                </div>
                            </div>
                            ...
                            <div class="account-group">
                                <div class="account-input-group">
                                    ...
                                    <input type="text" name="pwd" class="account-group-input" required="required"
                            ...
                            <div class="account-group">
                                <div class="account-input-group">
                                    ...
                                    <input type="text" name="qq" class="account-group-input" required="required"
                                           placeholder="输入QQ号，用于找回密码"/>
                                </div>
                            </div>
                            <!--                            取消验证码-->
                            <!--                            <div class="account-group">-->
                            ...
                            <!--                                    <input type="text" name="code" value="" class="account-group-input-code"-->
                            <!--                                           required="required" placeholder="输入验证码"/>-->
                            <!--                                    <span class="input-group-addon" style="padding: 0">-->
                            <!--                                        <img id="codeimg" src="./code.php?r=1718730732" height="35"-->
                            ...
                            <div class="account-group">
                                <div class="account-input-group">
                                    ...
                                    <input type="number" name="phone" value="" class="account-group-input"
                            ...
                            <div class="account-group">
                                <div class="account-input-group">
                                    <span class="account-input-addon-icon fa fa-adjust"></span>
                                    <input type="text" name="code" value="" class="account-group-input-code"
                                           required="required" placeholder="请输入验证码">
                                    <input type="button" class="send1 input-code-button" style="font-size: 10px;"
                                           onclick="send()" value="获取验证码">
                                </div>
...
<script src="../assets/js/reguser.js?ver=2055"></script>
<script>
    function goback() {
