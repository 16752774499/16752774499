...
<div class="col-xs-12 col-sm-10 col-md-6 col-lg-4 center-block " style="float: none; background-color:#f2f2f2;padding:0">
    ...
    <div class="top">
        ...
        <div class="layui-col-xs12"
            ...
            <span style="font-size: 1.2em;float: left;text-indent: 0.5em"><span style="color: #A6A6A6;font-size: 0.8em">共<?php echo $row['num'] ?>份，</span><span style="color: #A6A6A6;font-size: 0.8em">合计：</span><font style="font-size: 0.8em" color="#ffa56a;">￥<?php echo $row['money'] ?>元</font></span>
            <button class="layui-btn layui-btn-danger layui-btn-radius" type="submit" style="background: linear-gradient(to right, #ffa56a, #ffa56a);margin-right: 0.5em;" onclick="GoodsCart.PaySubmit('<?php echo $DataList ?>')">确认
            </button>
        </div>
    </div>
</div>
