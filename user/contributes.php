...
?>
                ...
                <div class="input-group" style="width:100%">
                    ...
                    <span class="input-group-btn" style="padding-right: 10px">
                        <a href="javascript:fileSelect()" title="上传图片">
                             ...
                             src="../assets/user/img/add_img.svg">
                        </a>
                   </span>
            ...
            <div class="form-group form-group-transparent form-group-border-bottom">
                <textarea class="form-control" name="zyurl" placeholder="请输入资源下载地址,如：百度网盘分享链接"></textarea>
            </div>
            <div class="form-group form-group-transparent form-group-border-bottom">
                <div class="input-group" style="width:100%">
                    <div class="input-group-addon">
...
$desc=$_POST['desc'];
$goods_param=daddslashes($_POST['zyurl']);
$wx_test=daddslashes($_POST['wx_test']);
$yhid=$userrow['zid'];
$sql="insert into `pre_tools` (`name`,`cid`,`pro`,`shopimg`,`desc`,`zyurl`,`wx_test`,`close`,`active`,`addtime`) values (:name,:cid,:pro,:shopimg,:desc,:zyurl,:wx_test,1,0,NOW())";
	$data = [':name'=>$name, ':cid'=>$cid, ':pro'=>$yhid, ':shopimg'=>$shopimg, ':desc'=>$desc , ':zyurl'=>$goods_param , ':wx_test'=>$wx_test];
	if($DB->exec($sql, $data)){
