 ...
 <input type="date" class="form-control" name="endtime" value="'.date("Y-m-d",strtotime("+100 years")).'" required>
             ...
             <div class="form-group form-group-transparent form-group-border-bottom">
                <div class="input-group" style="width:100%">
                    ...
                    <input name="need" class="form-control" style="text-align: right;background:#fff;" value="0" disabled="">
...
if($DB->exec("UPDATE pre_site SET  domain=:domain,power=:power, sitename=:sitename,endtime=:endtime WHERE zid=:zid", [':domain'=>$domain,':sitename'=>$sitename, ':endtime'=>$endtime,  ':power'=>1,':zid'=>$zid])!==false)
  showmsg('<script type="text/javascript">
    		...
    		layer.open({
                ...
                shadeClose: false,
                closeBtn: 0,
                content: "<center><div class=\"showtip display-column justify-between align-center\" style=\"width:30rem;height: 22rem;\"><div class=\"showtip-title\"></div><div class=\"showtip-center  display-column justify-center align-center\"><img src=\"../assets/user/img/warning.png\" style=\"height:30%\"><div class=\"showtip-center-msg\">开通分站成功</div><div class=\"showtip-center-num\">3秒后返回上一页</div></div><div class=\"showtip-btn display-row justify-center align-center\"><a href=\"userlist.php\" class=\"showtip-btn-yes display-column justify-center align-center\">确认</a></div></div></center>",
                end: function(){ 
                  if(3){ 
