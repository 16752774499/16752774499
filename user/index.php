...
<div class="col-lg-4 col-md-6 col-sm-12">
	<div class="panel panel-default">
		...
		<?php if($userrow['power']>0){?>
			...
			<li style="font-weight:bold" class="list-group-item">站点类型：<?php echo ($userrow['power']==2?'<font color=red>顶级合伙人版</font>':'<font color=red>分站站长版</font>')?>&nbsp;<?php if($conf['fenzhan_upgrade']>0 && $userrow['power']==1){echo '<a href="upsite.php" class="btn btn-danger btn-xs pull-right">升级站点</a>';}else{echo '<a href="./sitelist.php" class="btn btn-danger btn-xs pull-right">下级管理</a>';}?></li>
